...
#define STRING_CONFIG_H_AUTHOR "(RICARDO 1,4SRK TURBO)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "3D Frankestain"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 4000, 150 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 7, 24, -5 }
